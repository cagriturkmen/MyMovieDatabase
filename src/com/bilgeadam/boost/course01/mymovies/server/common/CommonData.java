...
public class CommonData {
	...
	public void loadPropertiesFile(String[] args) {
		if (args.length == 0) {
			// program�n �al��t��� lokasyonu bulmak i�in. Her program muhakkak bir Thread
	...
	public void addMovie(Movie movie) {
		...
		this.addMovieToYear(movie); // y�llara g�re movie'leri grupland�rarak saklad���m�z alternatif liste
	...
	public void addMovieToYear(Movie movie) {
		ArrayList<String> yearsMovies = this.getMoviesByYear().get(movie.getStartYear()); // lazy get treemap arkas�ndan
																							// da get y�l film listesi
